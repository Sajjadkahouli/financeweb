...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('accNumber', models.PositiveIntegerField(unique=True, validators=[django.core.validators.MinValueValidator(999999999999999), django.core.validators.MaxValueValidator(10000000000000000)])),
                ('IBAN', models.PositiveBigIntegerField(unique=True, validators=[django.core.validators.MinValueValidator(99999999999999999999999), django.core.validators.MaxValueValidator(1000000000000000000000000)])),
                ('CVV2', models.PositiveBigIntegerField(validators=[django.core.validators.MinValueValidator(99), django.core.validators.MaxValueValidator(10000)])),
                ...
                ('credit', djmoney.models.fields.MoneyField(decimal_places=4, default_currency='USD', max_digits=14, null=True)),
                ('created_At', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            name='WalletBelongings',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('belonging_id', models.ManyToManyField(to='members.belonging')),
                ('wallet_id', models.ManyToManyField(to='members.wallet')),
            ],
        ),
        migrations.CreateModel(
            name='Income',
            fields=[
                ...
                ('cart', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='members.cart')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('walletbelongs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='members.walletbelongings')),
            ],
        ),
        migrations.CreateModel(
            name='Expense',
